...
<body>
  <?php
  $word = "Menko polhukam Mahfud md menyatakan pengelolaan otonomi khusus (otsus) papua tidak beres. karenanya, dana otsus dinaikkan menjadi 2,25 persen dari dana alokasi khusus apbn";
  ...
  <div class="container my-5">
    <div class="alert alert-success">
      <p><span class="fw-bold">Kalimat: </span><?= $word ?></p>
    </div>
    <div class="row">
      <div class="col-6">
